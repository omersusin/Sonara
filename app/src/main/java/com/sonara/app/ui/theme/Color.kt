...
val DarkPalette = SonaraColorPalette(
    ...
    card = Color(0xFF1F2127),
    cardElevated = Color(0xFF282A31),
    divider = Color(0xFF3A3C44),
    textPrimary = Color(0xFFF0F0F5),
    textSecondary = Color(0xFF9195A1),
...
val LightPalette = SonaraColorPalette(
    ...
    surfaceContainerHighest = Color(0xFFE0E1E6),
    card = Color(0xFFFFFFFF),
    cardElevated = Color(0xFFF5F5F8),
    divider = Color(0xFFD4D5DA),
    textPrimary = Color(0xFF1B1C20),
...
val AmoledPalette = SonaraColorPalette(
    ...
    card = Color(0xFF111116),
    cardElevated = Color(0xFF1A1A20),
    divider = Color(0xFF2A2A30),
    textPrimary = Color(0xFFF0F0F5),
    textSecondary = Color(0xFF8A8D96),
    textTertiary = Color(0xFF62666F)
)
