package com.sonara.app.ui.icons
...
/**
 * Custom icons that intentionally diverge from the stock Material Icons set —
 * Sonara prefers the rounded Material Symbols hearts (matches Pano Scrobbler)
 * over the standard `Icons.Filled.Favorite` shape.
 */
object SonaraIcons {

    val HeartOutline: ImageVector by lazy {
        ImageVector.Builder(
            name = "Sonara.HeartOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            viewportHeight = 960f
